          ...
          <div class="container">
            <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
              <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                <div class="col-span-full lg:col-span-2">
                  <div class="flex items-center">
                    <SiteLogo white={true} className={"my-white-logo w-44"} />
                  </div>
                  <p class="text-white mt-6">
                    This may include the company's address, phone number, email
                    address, and links to social media profiles Links to
                    important pages within the website, such as the homepage
                  </p>
                </div>
                ...
                <div class="col-span-1">
                  ...
                  <div class="mt-6 grid space-y-3">
                    <p>
                      <Link
                        class="inline-flex gap-x-2 text-white hover:text-gray-200"
                        to="/projects"
                      >
                        Projects
                      </Link>
                ...
                <div class="col-span-1">
                  ...
                  <div class="mt-6 grid space-y-3">
                    <img src={footerimage} class="h-12" alt="imagef" />
                    <img src={footerimage} class="h-12" alt="imagef" />
                  </div>
                </div>
              </div>
              ...
              <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
                ...
                <div>
                  <Link class="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-white hover:bg-primary transition-all duration-300">
                    <svg
