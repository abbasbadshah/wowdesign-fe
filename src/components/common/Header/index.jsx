        ...
        <div className="px-16">
          <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            ...
            <div className="-mr-2 -my-2 md:hidden">
              <button
                type="button"
                className="bg-white rounded-md p-2 inline-flex items-center justify-center text-white hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-theme-color"
                  ...
                  <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                    <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                      <span className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                        ...
                        <svg
                          className="flex-shrink-0 h-6 w-6 text-theme-color"
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                    ...
                    <div className="px-5 py-5 bg-gray-50 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
                      <div className="flow-root">
                        <span className="-m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-900 hover:bg-gray-100">
                  ...
                  <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                    ...
                    <div className="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
                      ...
                      <div className="mt-5 text-sm">
                        <span className="font-medium text-theme-color hover:text-indigo-500">
                          {" "}
              ...
              <div className="flex items-center justify-between">
                <div>
                  <img
                    ...
                    src="https://tailwindui.com/img/logos/workflow-mark-theme-color.svg"
                    alt="Workflow"
                  />
                </div>
                <div className="-mr-2">
