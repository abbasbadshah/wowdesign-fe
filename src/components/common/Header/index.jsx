    ...
    >
      ...
      >
                ...
                {products.map((item) => (
                  ...
                  >
                    <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                      <item.icon
                        className="h-6 w-6 text-gray-600 group-hover:text-theme-color"
                        aria-hidden="true"
                      />
                    </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end gap-5 items-center">
          ...
          <Link
            to="/create-company"
            className="text-sm p-2 rounded bg-theme-color hover:bg-transparent border-2 border-theme-color font-semibold leading-6 text-white"
          >
            Create Company
          </Link>
        </div>
      ...
      >
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-[999] w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
