              ...
              {activeSection === "profile" && (
                <div className="relative p-6 bg-white rounded-md shadow">
                  ...
                  <p className="mt-3 text-black">
                    I have started my career as a trainee and proved myself and
                    achieved all the milestones with good guidance and reached
                    up to the project manager. In this journey, I understood all
                    the procedures which made me a good developer, team leader,
                    and project manager.
                  </p>
                </div>
              )}
