...
export const HomeMainSectionOne = () => {
  return (
    <div
      className="px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 pt-16 grid grid-cols-1 md:grid-col-6 lg:grid-cols-12 gap-4"
      id="next-section"
    >
      {/* First Image */}
        ...
        <div className="absolute inset-0 overlay flex p-4 md:p-8">
          <div className="text-overlay flex flex-col justify-between text-left text-white">
            ...
            <div className="flex items-center text-base md:text-xl tracking-wider group">
              ...
              <ArrowRightIcon className="ml-2 transition-transform transform group-hover:translate-x-1" />
            </div>
          </div>
        </div>
      </div>
