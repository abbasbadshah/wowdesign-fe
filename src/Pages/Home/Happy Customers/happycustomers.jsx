...
const HappyCustomers = () => {
  return (
    <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[150px]">
      <div className="rounded px-5 py-24 lg:pt-[96px] lg:px-[122px] lg:pb-[139px] bg-[#FBF5EE]">
        ...
        <div className="grid grid-cols-1 gap-y-8 gap-x-[30px] lg:grid-cols-3">
          <div className="rounded py-[40px] px-[30px] md:py-[55px] md:px-[48px] hover:translate-y-[-3px] transition-all duration-300 bg-white">
            ...
            <img
                className="h-full w-full object-cover max-w-[80px] rounded"
                src={Avatar}
                alt="avatar"
              />
              <div>
                <p className="text-lead font-bold mb-[3px]">Jane Cooper</p>
                <p className="text-md text-gray-500">Biffco Enterprises Ltd.</p>
              </div>
            </div>
          </div>
          <div className="rounded py-[40px] px-[30px] md:py-[55px] md:px-[48px] hover:translate-y-[-3px] transition-all duration-300 bg-white">
          ...
          <div className="rounded py-[40px] px-[30px] md:py-[55px] md:px-[48px] hover:translate-y-[-3px] transition-all duration-300 bg-white">
            ...
            <div className="flex items-center gap-6">
              ...
              />
              <div>
                <p className="text-lead font-bold mb-[3px]">Leslie Alexander</p>
